...
class Hparams:
    ...
    batch_size: int = 4 # size of the batches (20 sulla mia  mcchina)
    ...
    conf_threshold: float = 0.1 # first threshold filtering
    
    # LOGGING params
    log_images: int = 2 # how many images to log each time
