...
class Hparams:
    ...
    max_number_images: int = 1000
    num_classes: int = 3 # number of classes in the dataset
    augmentation: bool = True # apply augmentation strategy to input images and bounding boxes
    ...
    batch_size: int = 16 # size of the batches (16 on my local machine)
